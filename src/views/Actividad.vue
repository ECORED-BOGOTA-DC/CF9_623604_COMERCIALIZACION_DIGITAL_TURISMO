  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Introducción a los conceptos de producción de contenido digital
        p.mb-4 Identificar los conceptos propios del proceso de producción digital, para la toma de decisiones permitan acercar la empresa, producto o servicio al cliente.
